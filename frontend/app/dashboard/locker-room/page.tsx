  ...
  return (
    ...
    >
      ...
      <header className="h-16 border-b border-border flex items-center justify-between px-8 sticky top-0 bg-bgPrimary/80 backdrop-blur-sm z-50">
        <div className="flex items-center gap-6">
          ...
          <nav className="flex gap-4">
            ...
            <Link href="/dashboard/locker-room" className="font-mono text-[10px] text-textPrimary uppercase tracking-[2px] border-b border-accentRed">LOCKER ROOM</Link>
      ...
      <main className="p-8 max-w-[800px] mx-auto w-full">
        <h1 className="font-display font-black text-4xl text-textPrimary uppercase mb-2 tracking-tight">
          THE LOCKER ROOM
        </h1>
        <p className="font-mono text-xs text-textMuted uppercase tracking-[3px] mb-12">
